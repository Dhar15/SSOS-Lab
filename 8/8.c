/* Question - Design, develop and implement a C/C++/Java program to implement Banker’s algorithm. 
...
int avail[10],work[10],p,r,i,j,v=0;
bool finish[10];
...
int main()
{
	...
	for(i=0;i<p;i++)
	{
		if(finish[i] == false)
		{
			printf("All processes are not safely allocated\n");
			exit(0);
		}
	}
